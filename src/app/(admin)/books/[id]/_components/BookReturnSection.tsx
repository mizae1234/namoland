        ...
        return (
            <div className="mt-6 bg-emerald-50 rounded-2xl border border-emerald-200 p-6">
                <div className="text-center">
                    ...
                    <p className="font-bold text-emerald-700">คืนหนังสือ "{bookTitle}" สำเร็จ!</p>
                    {result.remainingCount! > 0 && (
                        <p className="text-sm text-amber-600 mt-1">ยังเหลืออีก {result.remainingCount} เล่มในรายการยืม</p>
                    )}
                    <p className="text-xs text-emerald-500 mt-2">กำลังรีเฟรชหน้า...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="mt-6 bg-white rounded-2xl border border-amber-200 shadow-sm p-6">
            <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-lg font-semibold text-[#3d405b]">หนังสือกำลังถูกยืม</h2>
            </div>

            <div className="bg-amber-50 rounded-xl p-3 mb-4 text-sm">
                <div className="flex items-center gap-2 text-amber-700">
                    <User size={14} />
                    <span>ผู้ยืม: <strong>{borrowerName}</strong></span>
                </div>
                <p className="text-xs text-amber-600 mt-1">รหัสยืม: {borrowCode} · เล่มนี้เป็น 1 ใน {totalItems} เล่ม</p>
            ...
            {!confirm ? (
                ...
                <div className="space-y-2">
                    <p className="text-sm text-[#3d405b]/60 text-center">ยืนยันคืน &ldquo;{bookTitle}&rdquo; ?</p>
