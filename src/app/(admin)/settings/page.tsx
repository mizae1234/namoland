...
export default async function SettingsPage() {
    const [shopInfo, packages, activities, schedules, adminUsers, session] =
        await Promise.all([
            getShopInfo(),
    ...
    return (
        <div>
            <div className="mb-6">
                ...
                <p className="text-[#3d405b]/50 mt-1">จัดการข้อมูลร้าน แพ็คเกจ กิจกรรม ตารางคลาส และผู้ใช้ระบบ</p>
            </div>
