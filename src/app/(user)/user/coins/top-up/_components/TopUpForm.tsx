        ...
        return (
            <div className="p-4">
                <div className="bg-emerald-50 rounded-2xl p-8 text-center">
                    ...
                    <h2 className="text-lg font-bold text-emerald-800 mb-2">แจ้งโอนสำเร็จ!</h2>
                    <p className="text-sm text-emerald-600 mb-6">
                        กรุณารอ admin ตรวจสอบ เหรียญจะเข้าบัญชีเมื่ออนุมัติ
                    </p>
                    <Link
                        href="/user/coins"
    ...
    return (
        <div className="p-4">
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <h1 className="text-lg font-bold text-[#3d405b]">เติมเหรียญ</h1>
            </div>
                ...
                <>
                    <div className="mb-6">
                        <p className="text-sm font-medium text-[#3d405b]/70 mb-3 flex items-center gap-2">
                            ...
                            โอนเงิน ฿{selectedPkg?.price.toLocaleString()}
                        </p>
                        {bankInfo.accountNumber ? (
                                ...
                                <div className="space-y-2 text-sm">
                                    {bankInfo.bankName && (
                                        <div className="flex justify-between">
                                            <span className="text-[#3d405b]/40">ธนาคาร</span>
                                            <span className="font-medium text-[#3d405b]/80">{bankInfo.bankName}</span>
                                        </div>
                                    )}
                                    <div className="flex justify-between items-center">
                                        <span className="text-[#3d405b]/40">เลขบัญชี</span>
                                    ...
                                    {bankInfo.accountName && (
                                        <div className="flex justify-between">
                                            <span className="text-[#3d405b]/40">ชื่อบัญชี</span>
                            ...
                            <div className="bg-amber-50 rounded-2xl p-4 border border-amber-100 text-center">
                                <p className="text-sm text-amber-700">ยังไม่ได้ตั้งค่าบัญชีธนาคาร กรุณาติดต่อ admin</p>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="mb-6">
                        ...
                        <textarea
                            ...
                            placeholder="หมายเหตุ (เช่น โอนแล้วเวลา 14:30 น.)"
                            rows={2}
                        ...
                        >
                            <Send size={18} />
                            {loading ? "กำลังส่ง..." : `แจ้งโอนเงิน ฿${selectedPkg?.price.toLocaleString()}`}
                        </button>
                    </div>
                </>
            )}
